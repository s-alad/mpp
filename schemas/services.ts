...
export const services: ServiceDef[] = [
  ...
  // ── OFAC Sanctions API ───────────────────────────────────────────────
  {
    ...
    serviceUrl: "https://ofac.mpp.paywithlocus.com",
    description:
    ...
    categories: ["data"],
    integration: "third-party",
    tags: ["sanctions", "compliance", "screening", "kyc", "aml"],
    docs: {
      homepage: "https://docs.ofac-api.com",
      llmsTxt: "https://paywithlocus.com/mpp/ofac.md",
    },
    provider: { name: "OFAC Sanctions API", url: "https://ofac-api.com" },
    realm: "ofac.mpp.paywithlocus.com",
    intent: "charge",
    payment: TEMPO_PAYMENT,
    endpoints: [
      {
        route: "POST /ofac/screen",
        desc: "Sanctions Screening",
        dynamic: true,
        amountHint: "$0.012/case",
      },
      {
        route: "POST /ofac/search",
        desc: "Sanctions Search",
        dynamic: true,
        amountHint: "$0.012/case",
      },
    ],
  ...
  // ── VirusTotal ───────────────────────────────────────────────────────
  {
    ...
    categories: ["data"],
    integration: "third-party",
    tags: ["malware", "security", "threat-intel", "file-scan", "url-scan"],
    docs: {
      homepage: "https://docs.virustotal.com/reference/",
      llmsTxt: "https://paywithlocus.com/mpp/virustotal.md",
    },
    provider: { name: "VirusTotal", url: "https://www.virustotal.com" },
    ...
    endpoints: [
      ...
      {
        route: "POST /virustotal/analysis",
        desc: "Analysis Status",
        amount: "55000",
        unitType: "request",
      },
      {
      ...
      {
        route: "POST /virustotal/dns-resolution",
        desc: "DNS Resolution",
        amount: "55000",
        unitType: "request",
      },
      ...
      {
        route: "POST /virustotal/popular-threat-categories",
        desc: "Popular Threat Categories",
        amount: "55000",
        unitType: "request",
      },
      {
      ...
      {
        route: "POST /virustotal/domain-votes",
        desc: "Domain Votes",
        amount: "55000",
        unitType: "request",
      },
      {
        route: "POST /virustotal/ip-votes",
        desc: "IP Votes",
        amount: "55000",
        unitType: "request",
      },
      ...
      {
        route: "POST /virustotal/latest-comments",
        desc: "Latest Comments",
        amount: "55000",
        unitType: "request",
      },
      {
        route: "POST /virustotal/attack-tactic",
        desc: "Attack Tactic",
        amount: "55000",
        unitType: "request",
      },
      {
        route: "POST /virustotal/attack-technique",
        desc: "Attack Technique",
        amount: "55000",
        unitType: "request",
      },
    ],
